    ...
    UIObject(scene)
{
    ...
    logo->GetLocalRect().offsetMin.Set(-0.5f * logoW, 0.0f + 400);
    logo->GetLocalRect().offsetMax.Set(+0.5f * logoW, logoW / ratio + 400);
    logo->SetParent(this);
    ...
    float jblogoW = 600.0f;
    jblogo->GetLocalRect().anchorMin.Set(0.5f, 0.0f);
    jblogo->GetLocalRect().anchorMax.Set(0.5f, 0.0f);
    jblogo->GetLocalRect().offsetMin.Set(-0.5f * jblogoW, 0.0f);
    jblogo->GetLocalRect().offsetMax.Set(+0.5f * jblogoW, jblogoW / jbratio +0.0f);
